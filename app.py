...
api.add_resource(Player, '/v2_1/players/player=<string:player_id>')
api.add_resource(Player, '/v2_1/players/player=<string:player_id>&positions=<string:positions>')
api.add_resource(Player, '/v2_1/players/positions=<string:positions>')
