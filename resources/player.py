            ...
            if (self.is_pitcher):
                ...
                return (
                    f'SELECT ' 
                        ...
                        f'num_pitches AS "pitch-count", num_hits AS "hits", num_bb AS "bb", num_1b AS "1b", num_2b AS "2b", num_3b AS "3b", num_hr AS "hr", num_k AS "k",num_pa AS "pa",num_strike AS "strikes", num_ball AS "balls", num_foul::int AS "foul", num_ibb::int AS "ibb", num_hbp::int AS "hbp", num_wp::int AS "wp", num_rbi AS "rbi" '
